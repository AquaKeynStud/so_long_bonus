...
/*   Updated: 2025/03/05 16:36:58 by arocca           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static bool	load_images(void *mlx, void *imgs[5], char *paths[5])
{
	...
	while (i < 5)
	{
		imgs[i] = mlx_xpm_file_to_image(mlx, paths[i], (int *)SX, (int *)SY);
		if (!imgs[i])
...
bool	init_images(void *mlx, t_images *img)
{
	...
	imgs[0] = (void *)&img->wall;
	imgs[1] = (void *)&img->floor;
	imgs[2] = (void *)&img->collec;
	imgs[3] = (void *)&img->player;
	imgs[4] = (void *)&img->exit;
